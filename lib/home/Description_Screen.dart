                          ...
                          return AlertDialog(
                            ...
                            actions: <Widget>[
                              ...
                              ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(backgroundColor: Color(0xf0003333),
                                  )),
                            ],
                          );
                        });
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Text("02: Memory:" + widget.memory,style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.w700,
                          fontSize: 13
                      ),),
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Text("03: Storage:" + widget.storage,style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.w700,
                          fontSize: 13
                      ),),
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Text("04: processor:"+widget.processor,style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.w700,
                          fontSize: 13
                      ),),
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Text("05: Display:" +widget.display,style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.w700,
                          fontSize: 13
                      ),),
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Text("06: Power:" +widget.power,style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.w700,
                          fontSize: 13
                      ),),
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Text("07: battery:" + widget.battery,style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.w700,
                          fontSize: 13
                      ),),
